...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ЭтоНовый() Тогда
		...
		//		
		//		СтруктураРеквизитов = __ОбщегоНазначенияСервер.ПолучитьЗначенияРеквизитов(Ссылка, "ПодписанЭЦП, Зашифрован");
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ЭтоНовый() Тогда
		...
		ИндексКартинки = РассылкаОтчетовКлиентСервер.ПолучитьИндексПиктограммыФайла(Неопределено);
