...
КонецПроцедуры // СохранитьНастройкиПользователяВРазделе
...
КонецПроцедуры // СброситьНастройкиПользователяВРазделе
...
КонецПроцедуры // СброситьНастройкиВариантаОтчета
