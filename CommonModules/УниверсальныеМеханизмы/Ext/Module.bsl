...
Функция ВосстановлениеНастроек(СтруктураНастройки,НастройкиВсехПользователей=Ложь) Экспорт
	
	ФормаУправленияНастройками = РегистрыСведений.СохраненныеНастройки.ПолучитьФорму("ФормаУправленияНастройками");
	ФормаУправленияНастройками.НастройкиВсехПользователей = НастройкиВсехПользователей;
...
Функция ПолучитьЗначениеНастройки(СтруктураНастройки, ИмяЗначения) Экспорт
	...
	СтруктураНастройки.Свойство(ИмяЗначения, Значение);
