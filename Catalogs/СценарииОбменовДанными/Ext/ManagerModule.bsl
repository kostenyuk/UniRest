...
Функция ПолучитьСценарий(УзелИнформационнойБазы) Экспорт
	Запрос = Новый Запрос;
	Запрос.Текст = 
		"ВЫБРАТЬ
	...
	Если ВыборкаДетальныеЗаписи.Следующий() Тогда
		СценарийОбменаДанными = ВыборкаДетальныеЗаписи.Ссылка;
...
Процедура СоздатьСценарий(УзелИнформационнойБазы, Расписание = Неопределено) Экспорт
	...
	СценарийОбменаДаннымиСсылка = ПолучитьСценарий(УзелИнформационнойБазы);
	
	Если СценарийОбменаДаннымиСсылка.Пустая() Тогда
		СценарийОбменаДанными = Справочники.СценарииОбменовДанными.СоздатьЭлемент();
	Иначе
		СценарийОбменаДанными = СценарийОбменаДаннымиСсылка.ПолучитьОбъект();
	...
	СтрокаТаблицы.КоличествоЭлементовВТранзакции = 0;
