...
Процедура ДействияПередНачаломРаботыСистемы(Отказ) Экспорт
	...
	ОбменДаннымиКлиент.ПередНачаломРаботыСистемы(Отказ, ПараметрыКлиента, ОбновитьПараметрыКлиента);
	Если Отказ Тогда
		Возврат;
	КонецЕсли;
	...
	// СтандартныеПодсистемы.БазоваяФункциональность
	ОбменДаннымиКлиент.ПередНачаломРаботыСистемы(Отказ);
...
Функция ОбработатьПараметрыЗапуска()
	...
	СоединенияИБКлиент.ПриОбработкеПараметровЗапуска(ПервыйПараметр, ПараметрыЗапуска, Отказ);
	ОбменДаннымиКлиент.ПриОбработкеПараметровЗапуска(ПервыйПараметр, ПараметрыЗапуска, Отказ);
