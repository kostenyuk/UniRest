...
//.. Начало изменения Dim)on  6 октября 2013 г. 23:54:15
//

Функция ПолучитьТекущийРесторан() Экспорт

	Ресторан = ПланыОбмена.ОбменДанными2K_CRS.ЭтотУзел().Ресторан;

	Возврат Ресторан
	
КонецФункции // ()

Функция ПолучитьТипЦенТекущегоРесторана() Экспорт

	ТипЦен = ПолучитьТекущийРесторан().ТипЦен;
	
	Возврат ТипЦен

КонецФункции // ()

Функция ПолучитьУзелПоТипуЦенРесторана(ТипЦены, ЭтотУзел) Экспорт
	...
	|ГДЕ
	|	ОбменДанными2K_CRS.Ресторан.ТипЦен = &ТипЦен
...
Функция ПолучитьТаблицуИерархииИдентификаторов(ГруппаОбъекта = "") Экспорт //Костенюк Александр 24.12.2013
	...
	//Возврат ПланыОбмена.ОбменДанными2K_CRS.ПолучитьТаблицуИерархииИдентификаторов()	
	Возврат ПланыОбмена.ОбменДанными2K_CRS.ПолучитьТаблицуИерархииИдентификаторов(ГруппаОбъекта); //Костенюк Александр 24.12.2013

КонецФункции // ()

Функция ПолучитьСписокОбъектовСоставаПланаОбмена(ИмяПланаОбмена, ПолучитьМетаданные) Экспорт

	Возврат ПроцедурыОбменаДаннымиFrontOffice_Restoran.ПолучитьСписокОбъектовСоставаПланаОбмена(ИмяПланаОбмена, ПолучитьМетаданные)	

КонецФункции // ()

//
//.. Конец изменения Dim)on  6 октября 2013 г. 23:54:15
