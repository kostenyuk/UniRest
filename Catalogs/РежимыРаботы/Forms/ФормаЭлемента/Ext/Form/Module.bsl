...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	РегистрыСведений.НастройкиПравДоступаПользователей.ПолучитьПраваДоступаПользователей(ОбъектЗаполнения, Новый ОписаниеТипов("СправочникСсылка.РабочиеЦентры, СправочникСсылка.ВидыМеню, СправочникСсылка.Меню"), ПраваДоступаПользователей);

	// Принадлежность.
	__РаботаСДаннымиКлиентСервер.ПолучитьПравилаПринадлежности(ТекущийОбъект, "Компьютеры", "РежимРаботы", ПравилаПринадлежности);
...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	// Принадлежность.
	__РаботаСДаннымиКлиентСервер.УстановитьПравилаПринадлежности(ТекущийОбъект, "Компьютеры", "РежимРаботы", ПравилаПринадлежности, Отказ);
