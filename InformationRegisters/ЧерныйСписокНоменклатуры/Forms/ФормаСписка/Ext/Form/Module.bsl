...
Процедура ОчиститьСписокСервер()
	...
	РегистрыСведений.ЧерныйСписокНоменклатуры.ОчиститьСписокНоменклатуры(Неопределено, Истина);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Настройка формы.
	Элементы.ОчиститьСписок.Доступность = ПравоДоступа("Изменение", Метаданные.РегистрыСведений.ЧерныйСписокНоменклатуры);
