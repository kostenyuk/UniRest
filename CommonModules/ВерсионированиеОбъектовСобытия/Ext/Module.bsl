...
Процедура ВерсионированиеОбъектовПриЗаписиОбъекта(Источник, Отказ) Экспорт
	...
	Если ОбъектВерсионируется(Источник, ЧислоВерсийОбъекта) Тогда
		...
		РегистрыСведений.ВерсииОбъектов.ЗаписатьВерсиюОбъекта(Источник.Ссылка, ЧислоВерсийОбъекта, ХранилищеДанных);
	КонецЕсли;
...
Функция ОбъектВерсионируется(знач Источник, ЧислоВерсийОбъекта)
	...
	Если ИспользоватьВерсионированиеОбъектов Тогда
		...
		УстановитьПривилегированныйРежим(Истина);
		ВариантВерсионирования = ПолучитьФункциональнуюОпцию("ВариантыВерсионированияОбъектов", Новый Структура("ТипОбъектаКонфигурации", ПолноеИмяОбъектаМетаданных));
