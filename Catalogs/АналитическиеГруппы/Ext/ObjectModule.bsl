...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Ссылка.Пустая() Тогда
		Если Не Справочники.АналитическиеГруппы.ПроверитьМаксимальноеКоличествоЭлементов() Тогда
...
Процедура ПередЗаписью(Отказ)
	...
	Если ПустаяСтрока(Поиск) Тогда
		МаксимальноеКоличество = Справочники.АналитическиеГруппы.ПолучитьМаксимальноеКоличествоЭлементов();
		
		Запрос = Новый Запрос("ВЫБРАТЬ
		                      |	АналитическиеГруппы.Поиск
		                      |ИЗ
...
Процедура ПриЗаписи(Отказ)
	...
	// Запись комбинаций.
	Справочники.КомбинацииАналитическихГрупп.СформироватьКомбинацииГрупп(Отказ, ЭтотОбъект);
